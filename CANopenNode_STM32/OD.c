...
typedef struct {
    ...
    OD_obj_var_t o_6001_test_Object;
} ODObjs_t;
...
static CO_PROGMEM ODObjs_t ODObjs = {
    ...
    .o_1012_COB_IDTimeStampObject = {
        .dataOrig = &OD_RAM.x1012_COB_IDTimeStampObject,
        .attribute = ODA_SDO_RW | ODA_MB,
        .dataLength = 4
    },
    .o_1014_COB_ID_EMCY = {
    ...
    .o_6001_test_Object = {
        .dataOrig = &OD_RAM.x6001_test_Object,
        .attribute = ODA_SDO_RW | ODA_MB,
        .dataLength = 4
    }
};
...
static OD_ATTR_OD OD_entry_t ODList[] = {
    ...
    {0x6001, 0x01, ODT_VAR, &ODObjs.o_6001_test_Object, NULL},
